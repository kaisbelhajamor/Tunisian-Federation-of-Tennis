    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if ($pathinfo === '/admin/stat') {
                return array (  '_controller' => 'Ftt\\BackofficeBundle\\Controller\\DefaultController::statAction',  '_route' => 'stat',);
            }

            // comment
            if ($pathinfo === '/admin/comment') {
                return array (  '_controller' => 'Ftt\\BackofficeBundle\\Controller\\DefaultController::commentAction',  '_route' => 'comment',);
            }
