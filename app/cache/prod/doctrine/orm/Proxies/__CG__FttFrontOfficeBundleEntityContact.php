 ...
 */
class Contact extends \Ftt\FrontOfficeBundle\Entity\Contact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'mail', 'message', 'date', 'readed', 'reply'];
        }
    ...
    public function isReply()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isReply', []);
