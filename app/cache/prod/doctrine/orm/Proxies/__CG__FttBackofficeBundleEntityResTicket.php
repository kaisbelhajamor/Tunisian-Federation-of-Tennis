 ...
 */
class ResTicket extends \Ftt\BackofficeBundle\Entity\ResTicket implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ftt\\BackofficeBundle\\Entity\\ResTicket' . "\0" . 'id', '' . "\0" . 'Ftt\\BackofficeBundle\\Entity\\ResTicket' . "\0" . 'login', '' . "\0" . 'Ftt\\BackofficeBundle\\Entity\\ResTicket' . "\0" . 'ticket', '' . "\0" . 'Ftt\\BackofficeBundle\\Entity\\ResTicket' . "\0" . 'date', '' . "\0" . 'Ftt\\BackofficeBundle\\Entity\\ResTicket' . "\0" . 'matchs'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ResTicket $proxy) {
