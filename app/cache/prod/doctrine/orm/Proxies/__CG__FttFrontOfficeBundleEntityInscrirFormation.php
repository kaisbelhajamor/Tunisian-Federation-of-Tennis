 ...
 */
class InscrirFormation extends \Ftt\FrontOfficeBundle\Entity\InscrirFormation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ftt\\FrontOfficeBundle\\Entity\\InscrirFormation' . "\0" . 'id', '' . "\0" . 'Ftt\\FrontOfficeBundle\\Entity\\InscrirFormation' . "\0" . 'nom', '' . "\0" . 'Ftt\\FrontOfficeBundle\\Entity\\InscrirFormation' . "\0" . 'prenom', '' . "\0" . 'Ftt\\FrontOfficeBundle\\Entity\\InscrirFormation' . "\0" . 'cin', '' . "\0" . 'Ftt\\FrontOfficeBundle\\Entity\\InscrirFormation' . "\0" . 'mail', '' . "\0" . 'Ftt\\FrontOfficeBundle\\Entity\\InscrirFormation' . "\0" . 'grade', '' . "\0" . 'Ftt\\FrontOfficeBundle\\Entity\\InscrirFormation' . "\0" . 'etat', '' . "\0" . 'Ftt\\FrontOfficeBundle\\Entity\\InscrirFormation' . "\0" . 'idformation'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InscrirFormation $proxy) {
