 ...
 */
class Club extends \Ftt\BackofficeBundle\Entity\Club implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ftt\\BackofficeBundle\\Entity\\Club' . "\0" . 'id', '' . "\0" . 'Ftt\\BackofficeBundle\\Entity\\Club' . "\0" . 'nom', '' . "\0" . 'Ftt\\BackofficeBundle\\Entity\\Club' . "\0" . 'adresse', '' . "\0" . 'Ftt\\BackofficeBundle\\Entity\\Club' . "\0" . 'path', 'file'];
        }
